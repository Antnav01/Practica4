...
namespace Practica4
{
    ...
    #region modificacion comandos
    public enum Comand { Go, Pick, Drop, Items, Info, Bag, Quit };
#endregion
    class Program
    {
        ...
        public static bool ProcesaInput(string com, WallE.WallE w, Map m, ref string historial)
        {
